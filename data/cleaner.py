...
stations =['aeroporto', 'alameda', 'alfornelos', 'alto dos moinhos', 'alvalade', 'amadora este', 'ameixoeira', 'anjos', 'areeiro', 'avenida', 'baixa chiado', 'bela vista', 'cabo ruivo', 'cais do sodr�', 'campo grande', 'campo pequeno', 'carnide', 'chelas', 'cidade universit�ria', 'col�gio militar', 'encarna��o', 'entre campos', 'intendente', 'jardim zool�gico', 'laranjeiras', 'lumiar', 'marqu�s de pombal', 'martim moniz', 'moscavide', 'odivelas', 'olaias', 'olivais', 'oriente', 'parque', 'picoas', 'pontinha', 'pra�a de espanha', 'quinta das conchas', 'rato', 'reboleira', 'restauradores', 'roma', 'rossio', 'saldanha', 'santa apol�nia', 's�o sebasti�o', 'senhor roubado', 'telheiras', 'terreiro pa�o']
